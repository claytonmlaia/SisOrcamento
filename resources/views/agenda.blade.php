                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group">
                            <a onclick="aoClicarCadastrar()" href="" class="btn btn-primary"><i class="fas fa-plus"></i> NOVA</a>
                        </div>
                        <br>
                            ...
                            <table name="gradearquivos" class="busca-na-lista table table-striped col-md-12" cellspacing="0" cellpadding="0">
                                ...
                                @foreach($agendas as $agenda)
                                    <tr>
                                        ...
                                        <td>{{ $agenda->dada_acompanhamento->format('d/m/Y') }}</td>
                                        <td>@if($agenda->data_hora_acompanhado == null) AGENDADO @else ACOMPANHADO @endif</td>
                                        <td>
                                            <a onclick="aoClicarVisualizar({{ $agenda->id }})"class="btn btn-xs btn-outline-info" href="" title="Visualizar"><i class="fas fa-eye"></i></a>
                                            <a onclick="aoClicarEditar({{ $agenda->id }})" class="btn btn-xs btn-outline-primary" href="" title="Editar cliente"><i class="fas fa-edit editar"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
                        ...
                        {{--PAGINAÇÃO--}}
                        {{ $agendas->appends(Request::input())->links() }}
                    </div>
                </div>
            </div>
        </div>
