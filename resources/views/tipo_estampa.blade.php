                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group">
                            <a onclick="aoClicarCadastrar()" href="" class="btn btn-primary"><i class="fas fa-plus"></i> NOVO</a>
                        </div>
                        <br>
                        ...
                        <div class="input-group">
                            <table name="gradearquivos" class="busca-na-lista table table-striped col-md-12" cellspacing="0" cellpadding="0">
                                ...
                                <tbody>
                                @foreach($tipo_estampas as $tipo_estampa)
                                    <tr>
                                        <td>{{ $tipo_estampa->id }}</td>
                                        <td>{{ $tipo_estampa->tipEstDescricao }}</td>
                                        <td>R$ {{ number_format($tipo_estampa->tipEstPreco, 2, ',', '.') }}</td>
                                        <td>
                                            <a onclick="aoClicarVisualizar({{ $tipo_estampa->id }})"class="btn btn-xs btn-outline-info" href="" title="Visualizar"><i class="fas fa-eye"></i></a>
                                            <a onclick="aoClicarEditar({{ $tipo_estampa->id }})" class="btn btn-xs btn-outline-primary" href="" title="Editar cliente"><i class="fas fa-edit editar"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
                        ...
                        {{--PAGINAÇÃO--}}
                        {{ $tipo_estampas->appends(Request::input())->links() }}
                    </div>
                </div>
            </div>
        </div>
