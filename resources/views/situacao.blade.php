            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group">
                            <table name="gradearquivos" class="busca-na-lista table table-striped col-md-12" cellspacing="0" cellpadding="0">
                                ...
                                @foreach($situacao as $sit)
                                    <tr>
                                        <td>{{ $sit->id }}</td>
                                        <td>{{ $sit->sitDescricao }}</td>
                                        <td>
                                            <a onclick="aoClicarVisualizar({{ $sit->id }})"class="btn btn-xs btn-outline-info" href="" title="Visualizar"><i class="fas fa-eye"></i></a>
                                            <a onclick="aoClicarEditar({{ $sit->id }})" class="btn btn-xs btn-outline-primary" href="" title="Editar cliente"><i class="fas fa-edit editar"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
                        ...
                        {{--PAGINAÇÃO--}}
                        {{ $situacao->appends(Request::input())->links() }}
                    </div>
                </div>
            </div>
        </div>
